...
#from pkd.evaluation.rank_cylib.rank_cy import evaluate_cy
    from pkd.evaluation.rank_cylib.a2 import a2
    IS_CYTHON_AVAI = True
except ImportError:
...
def eval_face(distmat, q_pids, g_pids, max_rank):
...
def fast_evaluate_rank_face(
    ...
    Args:
        ...
        use_cython (bool, optional): use cython code for evaluation. Default is True.
            ...
            by more than 10x. This requires Cython to be installed.
    """
    print(use_cython, IS_CYTHON_AVAI)
    if use_cython and IS_CYTHON_AVAI:
        return a2(
            distmat, q_pids, g_pids, max_rank
        )
    else:
        return eval_face(
            distmat, q_pids, g_pids, max_rank
