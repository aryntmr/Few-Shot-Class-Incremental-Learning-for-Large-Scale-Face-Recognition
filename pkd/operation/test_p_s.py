...
from pkd.evaluation import (fast_evaluate_rank, compute_distance_matrix, fast_evaluate_rank_face)
from sklearn.metrics.pairwise import pairwise_distances
from sklearn.metrics import average_precision_score
import numpy as np
from sklearn.preprocessing import normalize

def fast_test_face_recognition(config, base, loaders, current_step, flag, if_test_forget=True):
    ...
    def _cmc_map(_query_features_meter, _gallery_features_meter):
        ...
        start3 = time.time()
        CMC, mAP = fast_evaluate_rank_face(distance_matrix,
    ...
    if flag == 0:
        for dataset_name, temp_loaders in loaders.test_loader_dict.items():
            ...
            end_loop = time.time()
            print("Time taken by loop:", end_loop-start_loop)
